    ...
    if post_validation:
        ...
        for prefix, entries in post_validation.items():
            if "average" in entries:
                ...
                print(f"    Average AHash Hamming Canonical: {avg.get('ahash_hamming_cannonical', 'N/A')}")
                print(f"    Average DHash Hamming Canonical: {avg.get('dhash_hamming_cannonical', 'N/A')}")
                print(f"    Average PHash Hamming Canonical: {avg.get('phash_hamming_cannonical', 'N/A')}")
                print(f"    Average PDQ Hamming Canonical: {avg.get('pdq_hamming_cannonical', 'N/A')}")
