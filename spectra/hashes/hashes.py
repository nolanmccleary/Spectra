...
PHASH = Hash_Wrapper(name="phash", func=generate_phash, colormode="grayscale", resize_height=32, resize_width=32, available_devices={"cpu"}) #Canonical Phash applies DCT on 32x32 downsample
