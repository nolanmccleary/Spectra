...
class Grayscale_Engine(Gradient_Engine):
    ...
    def compute_gradient(self, old_hash, scale_factor, height, width):
        ...
        new_hashes = torch.tensor([self.func(v, height, width) for v in cand_batch], dtype=torch.int32, device=self.device)     #[f[c11, c12, c13], f[c21, c22, c23], f[c31, c32, c33]] -> [h1, h2, h3]
