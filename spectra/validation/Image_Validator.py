...
def image_compare(img_path_1, img_path_2, lpips_func, device, verbose):
    ...
    return {
        ...
        "l2" : str(l2_score),
        "ahash_hamming_cannonical" : str(ahash_delta),
        "dhash_hamming_cannonical" : str(dhash_delta),
        "pdq_hamming_cannonical"   : str(pdq_delta),
        "phash_hamming_cannonical" : str(phash_delta),
