...
I also wanted to do this out of personal interest, because it's an under-researched subject and it's a good way to combine topics from DSP and modern ML in a way that encourages and rewards writing highly performant code on a modern stack.
...
Keep in mind the RGB hash algorithms are no longer supported and may not work out of the box.
