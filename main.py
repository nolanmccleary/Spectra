...
def attack_sequence(dev):
    ...
    engine.add_attack("phash_attack", images, image_input_dir, image_output_dir, PHASH, DEFAULT_HYPERPARAMETERS, 5, "lpips", 1, 30, dev, lpips_func = F_LPIPS, delta_scaledown=False)
